...
// Run manually with `npm run generate:icons` whenever the mark changes —
// outputs are committed static assets under public/, not generated on every
// build.
//
// The source SVGs in public/ are brand-neutral placeholders (see README) —
// swap them for real brand assets and re-run this script.
...
// Must match --color-primary-600 in src/styles.scss and the theme-color meta
// tag in src/index.html — see README's three-way-sync note.
const BRAND = '#3c4bc4';
...
async function renderMaskable(size) {
  ...
  // draw the mark at 65% scale, centered, over a solid field so the OS can
  // crop to any shape without clipping the mark or exposing transparency.
